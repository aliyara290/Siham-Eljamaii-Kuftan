    ...
    <PageContainer>
      <CollectionHero>
        <CollectionHeroOverlay>
          <CollectionInfo>
            <Heading title="وصل حديثاً" size="xxxl" color={true} />
            <CollectionDescription>تصفح أحدث التشكيلات التي وصلت إلى متجرنا وكن أول من يحصل عليها</CollectionDescription>
                ...
                <ProductCard key={product.id} viewMode={viewMode}>
                  <Link to={`/product/${product.slug}`}>
                    ...
                    <ProductDetails>
                      ...
                      <ProductMeta>
                        <ProductArrivalDate>وصل بتاريخ: {formatDate(product.dateAdded)}</ProductArrivalDate>
                        <ProductColors>
...
const CollectionHero = styled.div`
  ...
  margin-bottom: 4rem;
  background-image: url('https://ma.bouchrafilalilahlou.com/cdn/shop/files/1_bbd9b5db-1e17-469e-94bf-81e33a09f52a.jpg?crop=region&crop_height=1080&crop_left=108&crop_top=0&crop_width=864&v=1696787030&width=720');
`;
